# -*- coding: utf-8 -*-
"""Modul_3_Binary_Classification.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/github/fxrdhan/Binary-Classification-Exercise/blob/main/Modul_3_Binary_Classification.ipynb
...
for i, column in enumerate(cat_features.columns, 1):
    plt.subplot(2, 4, i)
    sns.countplot(y=data[column], palette='viridis', hue=data[column])
    plt.title(f'Distribusi {column}')
plt.tight_layout()
plt.show()
